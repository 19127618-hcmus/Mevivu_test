...
|
*/
Route::post('/ckfinder/upload', [PostController::class, 'uploadImage'])->name('ckfinder.upload');
Route::get('/posts/search', [PostController::class, 'search'])->name('posts.search');
Route::get('/posts/getPostData', [PostController::class, 'getPostData'])->name('posts.getPostData');
